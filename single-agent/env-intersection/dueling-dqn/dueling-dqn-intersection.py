...
class Dueling_DQN:
    ...
    def init_hyp(self):
        ...
        self.checkpoint_path = "single-agent/env-intersection/dueling-dqn/checkpoints/dueling-dqn-intersection.pth"
        self.do_render = True
...
def evaluate():
    checkpoint_path = "single-agent/env-intersection/dueling-dqn/checkpoints/dueling-dqn-intersection.pth"
