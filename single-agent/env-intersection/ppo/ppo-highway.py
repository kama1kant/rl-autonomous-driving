...
class PPO():
    ...
    def init_hyp(self):
        ...
        self.checkpoint_path = "single-agent/env-intersection/ppo/checkpoints/ppo-intersection.pth"
...
def evaluate():
    checkpoint_path = "single-agent/env-intersection/ppo/checkpoints/ppo-intersection.pth"
